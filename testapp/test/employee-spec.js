...
const resMessages = require('../config/responseMessages')
...
describe(testMessages.employee.controllerName, function () {
  ...
  describe(testMessages.employee.addUserApi, function () {
    it(testMessages.employee.unauthorized, function (done) {
    ...
    it(testMessages.employee.authorized, function (done) {
      Jwt.get_token(user1.email, 'admin@!2$').then((token) => {
        chai.request(server_address)
          ...
          .end((err, res) => {
            ...
            res.body.message.should.equal(testMessages.employee.SuccessfullyAddEmp)
  ...
  describe(testMessages.employee.removeUserApi, function () {
